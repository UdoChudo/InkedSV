...
function MOD:ToggleKeyBindingMode(deactivate, saveRequested)
  if not deactivate then
    Binder.active = true;
    SV:StaticPopupSpecial_Show(InkedSV_KeyBindPopup)
    ...
    SV:StaticPopupSpecial_Hide(InkedSV_KeyBindPopup)
...
local Check_OnClick = function(self)
  if(MOD.bindingsChanged) then 
    ...
    if InkedSV_KeyBindPopupCheckButton:GetChecked() then 
      LoadBindings(2)
      SaveBindings(2)
    else 
      LoadBindings(1)
...
function MOD:LoadKeyBinder()
  ...
  local pop = NewFrame("Frame", "InkedSV_KeyBindPopup", UIParent)
  ...
  moveText:SetFontObject(InkedSV_Font_Default)
  ...
  local checkButton = NewFrame("CheckButton", "InkedSV_KeyBindPopupCheckButton", pop, "OptionsCheckButtonTemplate")
  checkButton:SetStyle("CheckButton")
  _G["InkedSV_KeyBindPopupCheckButtonText"]:SetText(CHARACTER_SPECIFIC_KEYBINDINGS)
  ...
  local saveButton = NewFrame("Button", "InkedSV_KeyBindPopupSaveButton", pop, "OptionsButtonTemplate")
  saveButton:SetWidth(150)
  saveButton:SetStyle("Button")
  _G["InkedSV_KeyBindPopupSaveButtonText"]:SetText(L["Save"])
  saveButton:SetScript("OnClick", Save_OnClick)

  local discardButton = NewFrame("Button", "InkedSV_KeyBindPopupDiscardButton", pop, "OptionsButtonTemplate")
  discardButton:SetWidth(150)
  discardButton:SetStyle("Button")
  _G["InkedSV_KeyBindPopupDiscardButtonText"]:SetText(L["Discard"])
