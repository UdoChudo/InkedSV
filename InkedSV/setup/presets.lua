...
local hasOldConfigs = function()
	local installed = InkedSVLib:GetSafeData("install_version")
	if(installed) then
		return USE.."\nSaved\n"..SETTINGS, "Complete"
	else
...
local ColorThemes = {
	["data"] = {
		...
		["default"] = {
			...
			["shared"] = {
				["background"] = {
					["pattern"] 	= {file = "InkedSV Backdrop 2", 	size = 0, tiled = false},
					["premium"] 	= {file = "InkedSV Artwork 2", 	size = 0, tiled = false},
					["unitlarge"] 	= {file = "InkedSV UnitBG 2", 		size = 0, tiled = false},
					["unitsmall"] 	= {file = "InkedSV SmallUnitBG 2", size = 0, tiled = false},
				}
			},
			["unitframes"] = {
		...
		["kaboom"] = {
			...
			["shared"] = {
				["background"] = {
					["pattern"] 	= {file = "InkedSV Backdrop 13", 	size = 0, tiled = false},
					["premium"] 	= {file = "InkedSV Artwork 13", 	size = 0, tiled = false},
					["unitlarge"] 	= {file = "InkedSV UnitBG 13", 		size = 0, tiled = false},
					["unitsmall"] 	= {file = "InkedSV SmallUnitBG 13", size = 0, tiled = false},
				}
			},
			["unitframes"] = {
				["buff_bars"] = {.51, .79, 0, 1},
		...
		["classy"] = {
			...
			["shared"] = {
				["background"] = {
					["pattern"] 	= {file = "InkedSV Backdrop 9", 	size = 0, tiled = false},
					["premium"] 	= {file = "InkedSV Artwork 9", 	size = 0, tiled = false},
					["unitlarge"] 	= {file = "InkedSV UnitBG 9", 		size = 0, tiled = false},
					["unitsmall"] 	= {file = "InkedSV SmallUnitBG 9", size = 0, tiled = false},
				}
			},
			["unitframes"] = {
		...
		["dark"] = {
			...
			["shared"] = {
				["background"] = {
					["pattern"] 	= {file = "InkedSV Backdrop 3", 	size = 0, tiled = false},
					["premium"] 	= {file = "InkedSV Artwork 3", 	size = 0, tiled = false},
					["unitlarge"] 	= {file = "InkedSV UnitBG 3", 		size = 0, tiled = false},
					["unitsmall"] 	= {file = "InkedSV SmallUnitBG 3", size = 0, tiled = false},
				}
			},
			["unitframes"] = {
	...
	["dialog"] = {
		...
		["Desc2"] = L["You can always change fonts and colors of any element of InkedSV from the in-game configuration."],
...
local function LoadPageData()
	PAGE_DIALOG = {
		--PAGE 1
		{
			["SubTitle"] = (L["This is InkedSV version %s!"]):format(SV.Version),
...
function SV.Setup:GenerateBackdrops()
	...
	local preset = {
		["pattern"] = {file = "InkedSV Backdrop "..BG_INDEX, size = 0, tiled = false},
		["premium"] = {file = "InkedSV Artwork "..ART_INDEX, size = 0, tiled = false},
		["unitlarge"] = {file = "InkedSV UnitBG "..UNIT_INDEX, size = 0, tiled = false},
		["unitsmall"] = {file = "InkedSV SmallUnitBG "..UNIT_INDEX, size = 0, tiled = false}
	}
