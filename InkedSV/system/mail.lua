...
local MailMinion 				= _G["InkedSV_MailMinion"];
local MailMinionGetMail = _G["InkedSV_MailMinionGetMail"];
local MailMinionGetGold = _G["InkedSV_MailMinionGetGold"];
local MailMinionDelete 	= _G["InkedSV_MailMinionDelete"];
--[[
##########################################################
LOCAL VARS
##########################################################
