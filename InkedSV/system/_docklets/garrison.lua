...
local function LoadToolBarGarrison()
	...
	local garrison = SV.Dock:SetDockButton("BottomLeft", L["Landing Page"], "InkedSV_Garrison", SV.media.dock.garrisonToolIcon, SetGarrisonTooltip, "SecureActionButtonTemplate")
