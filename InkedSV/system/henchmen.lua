...
local OPTION_LEFT = [[Interface\Addons\InkedSV\assets\textures\Doodads\HENCHMEN-OPTION-LEFT]];
local OPTION_RIGHT = [[Interface\Addons\InkedSV\assets\textures\Doodads\HENCHMEN-OPTION-RIGHT]];
local OPTION_SUB = [[Interface\Addons\InkedSV\assets\textures\Doodads\HENCHMEN-SUBOPTION]];
local SWITCH = [[Interface\Addons\InkedSV\assets\textures\Doodads\HENCHMEN-MINION-SWITCH]];
local BUBBLE = [[Interface\Addons\InkedSV\assets\textures\Doodads\HENCHMEN-SPEECH]];
local SUBOPTIONS = {};
local HENCHMEN_DATA = {
	{
		...
		{-40,"Show Me All Options!","Config Screen","Click here to access the entire InkedSV configuration."}
	},
	{
...
local CALLOUTICON = {
	[[Interface\Addons\InkedSV\assets\textures\Doodads\HENCHMEN-CALLOUT]],
	[[Interface\Addons\InkedSV\assets\textures\Doodads\HENCHMEN-WTF]],
	[[Interface\Addons\InkedSV\assets\textures\Doodads\HENCHMEN-WTF]],
	[[Interface\Addons\InkedSV\assets\textures\Doodads\HENCHMEN-SRSLY]],
	[[Interface\Addons\InkedSV\assets\textures\Doodads\HENCHMEN-SRSLY]],
	[[Interface\Addons\InkedSV\assets\textures\Doodads\HENCHMEN-CALLOUT]],
	[[Interface\Addons\InkedSV\assets\textures\Doodads\HENCHMEN-CALLOUT]]
};
...
local function CreateHenchmenFrame()
	...
	HenchmenCalloutFramePic:SetTexture([[Interface\Addons\InkedSV\assets\textures\Doodads\HENCHMEN-CALLOUT]])
...
local function InitializeHenchmen()
	SV.HenchmenButton = SV.Dock:SetDockButton("BottomRight", "Call Henchman!", "InkedSV_Henchmen", [[Interface\AddOns\InkedSV\assets\textures\Dock\DOCK-ICON-HENCHMAN]])
