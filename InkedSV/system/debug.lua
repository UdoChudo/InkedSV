...
local SV = _G["InkedSV"];
local L = SV.L;
SV.ScriptError = _G["InkedSV_ScriptError"];
local ScriptErrorDialog = _G["InkedSV_ScriptErrorDialog"];
local ScriptErrorScrollBar = _G["InkedSV_ScriptErrorDialogScrollBar"];
...
_G.SlashCmdList["InkedSV_FRAME_DEBUG"] = DebugThisFrame;
_G.SLASH_InkedSV_FRAME_DEBUG1 = "/inkdf"
...
local function InitializeScriptError()
    ...
    SV.API:Set("ScrollBar", InkedSV_ScriptErrorDialogScrollBar)
...
_G.SlashCmdList["InkedSV_SHOW_ERRORS"] = _showErrors;
_G.SLASH_InkedSV_SHOW_ERRORS1 = "/showerrors"
