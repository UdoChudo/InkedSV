...
MOD.Plugins = {};
MOD.References = {};
MOD.ToolTip = CreateFrame("GameTooltip", "InkedSV_Report_ToolTip", UIParent, "GameTooltipTemplate");
...
function MOD:EnableReport(socket, name)
	...
	if obj.OnEvent and obj.events then
		...
		Socket_OnEvent(socket, "InkedSV_FORCE_RUN")
	end
...
function MOD:Load()
	...
	--BOTTOM CENTER BARS
	local bottomLeft = CreateFrame("Frame", "InkedSV_ReportsGroup1", SV.Dock.BottomCenter)
	...
	local bottomRight = CreateFrame("Frame", "InkedSV_ReportsGroup2", SV.Dock.BottomCenter)
	...
	--TOP CENTER BARS
	local topLeft = CreateFrame("Frame", "InkedSV_ReportsGroup3", SV.Dock.TopCenter)
	...
	local topRight = CreateFrame("Frame", "InkedSV_ReportsGroup4", SV.Dock.TopCenter)
