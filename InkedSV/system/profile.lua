...
SV.ProfileInterface = _G["InkedSV_ProfileInterface"];
local ProfileInterfaceDialog = _G["InkedSV_ProfileInterfaceDialog"];
local ProfileInterfaceHelp = _G["InkedSV_ProfileInterfaceHelp"];
local ProfileInterfaceScrollBar = _G["InkedSV_ProfileInterfaceDialogScrollBar"];
--[[
##########################################################
...
function SV:LinkProfile(key)
    ...
    self.SystemAlert["COPY_PROFILE_PROMPT"].OnAccept = function() InkedSVLib:CopyDatabase(key, true) end
...
function SV:CopyProfile(key)
    ...
    self.SystemAlert["COPY_PROFILE_PROMPT"].OnAccept = function() InkedSVLib:CopyDatabase(key) end
    self:StaticPopup_Show("COPY_PROFILE_PROMPT")
end

local ProfileInterface_ExportProfile = function(self)
    local t = InkedSVLib:ExportDatabase();
...
local ProfileInterface_ImportProfile = function(self)
    ...
    SV.SystemAlert["IMPORT_PROFILE_PROMPT"].OnAccept = function()
        ...
        if(input and input ~= '') then
            InkedSVLib:ImportDatabase(input)
        else
