...
-- @class file
-- @name AceInked
-- @author Steven Jackson (2014) Modified by keivamp (2020)
-- @release 1.0.0
...
local MAJOR, MINOR = "AceInked-1.0", 1
local AceInked, oldminor = LibStub:NewLibrary(MAJOR, MINOR)

if not AceInked then
...
do
	...
	function AceInked:GetBaseFrame()
	...
	function AceInked:GetBaseFrameWithWindow()
...
do
	...
	local sliderBackdrop = {
		["bgFile"] = [[Interface\AddOns\InkedSV\assets\backgrounds\TRANSPARENT]],
		["edgeFile"] = [[Interface\AddOns\InkedSV\assets\borders\DEFAULT]],
		["tile"] = false,
		["edgeSize"] = 1,
		["tileSize"] = 0,
	...
	local DropDownCache = {}
	function AceInked:GetDropDownFrame()
		local frame
		if next(DropDownCache) then
			...
			local slider = CreateFrame("Slider", nil, scrollframe)
				...
				slider:SetThumbTexture([[Interface\AddOns\InkedSV\assets\buttons\SCROLLBAR-KNOB]])
	...
	function AceInked:ReturnDropDownFrame(frame)
		ClearFrames(frame)
