...
MOD.media.castBar = [[Interface\AddOns\InkedSV\assets\statusbars\GRADIENT]];
MOD.media.comboIcon = [[Interface\AddOns\InkedSV_NamePlates\assets\COMBO-POINT]];
MOD.media.topArt = [[Interface\AddOns\InkedSV_NamePlates\assets\PLATE-TOP]];
MOD.media.bottomArt = [[Interface\AddOns\InkedSV_NamePlates\assets\PLATE-BOTTOM]];
MOD.media.rightArt = [[Interface\AddOns\InkedSV_NamePlates\assets\PLATE-RIGHT]];
MOD.media.leftArt = [[Interface\AddOns\InkedSV_NamePlates\assets\PLATE-LEFT]];
MOD.media.roles = [[Interface\AddOns\InkedSV_NamePlates\assets\PLATE-ROLES]];

SV:AssignMedia("font", "platename", "InkedSV Caps Font", 9, "OUTLINE");
SV:AssignMedia("font", "platenumber", "InkedSV Caps Font", 9, "OUTLINE");
SV:AssignMedia("font", "plateaura", "InkedSV Caps Font", 9, "OUTLINE");
SV:AssignMedia("globalfont", "platename", "InkedSV_Font_NamePlate");
SV:AssignMedia("globalfont", "platenumber", "InkedSV_Font_NamePlate_Number");
SV:AssignMedia("globalfont", "plateaura", "InkedSV_Font_NamePlate_Aura");
SV:AssignMedia("template", "Nameplate", "InkedSV_StyleTemplate_Nameplate");

SV.defaults[Schema] = {
	["themed"] = true,
	["filter"] = {},
	["barTexture"] = "InkedSV MultiColorBar",
	["font"] = DIALOGUE_FONT,
	["fontSize"] = 10,
	["fontOutline"] = "OUTLINE",
	["comboPoints"] = true,
