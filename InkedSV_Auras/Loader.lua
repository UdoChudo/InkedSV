...
MOD.media.hyperAuraIcons = {
	[[Interface\Addons\InkedSV_Auras\assets\AURA-STATS]],
	[[Interface\Addons\InkedSV_Auras\assets\AURA-HEART]],
	[[Interface\Addons\InkedSV_Auras\assets\AURA-POWER]],
	[[Interface\Addons\InkedSV_Auras\assets\AURA-HASTE]],
	[[Interface\Addons\InkedSV_Auras\assets\AURA-SPELL]],
	[[Interface\Addons\InkedSV_Auras\assets\AURA-CRIT]],
	[[Interface\Addons\InkedSV_Auras\assets\AURA-MASTERY]],
	[[Interface\Addons\InkedSV_Auras\assets\AURA-MULTISTRIKE]],
	[[Interface\Addons\InkedSV_Auras\assets\AURA-VERSATILITY]]
};
...
function MOD:LoadOptions()
	SV.Options.args[Schema] = {
		...
		set = function(a,b)
			...
			MOD:UpdateAuraHeader(InkedSV_PlayerBuffs, "buffs")
			MOD:UpdateAuraHeader(InkedSV_PlayerDebuffs, "debuffs")
		end,
		args = {
			intro = {
				order = 1,
			...
			auraGroups = {
				...
				args = {
					...
					buffs = {
						...
						set = function(a,b)MOD:ChangeDBVar(b,a[#a],"buffs");MOD:UpdateAuraHeader(InkedSV_PlayerBuffs, "buffs")end,
					...
					debuffs = {
						...
						set = function(a,b)MOD:ChangeDBVar(b,a[#a],"debuffs");MOD:UpdateAuraHeader(InkedSV_PlayerDebuffs, "debuffs")end,
						args = auraOptionsTemplate
					}
				}
			},
