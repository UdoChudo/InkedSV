...
if(LSM) then
	LSM:Register("background", "InkedSV Model BG 2", [[Interface\TALENTFRAME\DeathKnightBlood-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 3", [[Interface\TALENTFRAME\DeathKnightFrost-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 4", [[Interface\TALENTFRAME\DeathKnightUnholy-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 5", [[Interface\TALENTFRAME\DruidBalance-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 6", [[Interface\TALENTFRAME\DruidFeralCombat-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 7", [[Interface\TALENTFRAME\DruidRestoration-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 8", [[Interface\TALENTFRAME\HunterBeastMastery-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 9", [[Interface\TALENTFRAME\HunterMarksmanship-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 10", [[Interface\TALENTFRAME\HunterPetCunning-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 11", [[Interface\TALENTFRAME\HunterPetFerocity-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 12", [[Interface\TALENTFRAME\HunterPetTenacity-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 13", [[Interface\TALENTFRAME\HunterSurvival-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 14", [[Interface\TALENTFRAME\MageArcane-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 15", [[Interface\TALENTFRAME\MageFire-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 16", [[Interface\TALENTFRAME\MageFrost-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 17", [[Interface\TALENTFRAME\PALADINCOMBAT-TOPLEFT]]);
	LSM:Register("background", "InkedSV Model BG 18", [[Interface\TALENTFRAME\PALADINHOLY-TOPLEFT]]);
	LSM:Register("background", "InkedSV Model BG 19", [[Interface\TALENTFRAME\PALADINPROTECTION-TOPLEFT]]);
	LSM:Register("background", "InkedSV Model BG 20", [[Interface\TALENTFRAME\PriestDiscipline-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 21", [[Interface\TALENTFRAME\PriestHoly-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 22", [[Interface\TALENTFRAME\PriestShadow-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 23", [[Interface\TALENTFRAME\RogueAssassination-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 24", [[Interface\TALENTFRAME\RogueCombat-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 25", [[Interface\TALENTFRAME\RogueSubtlety-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 26", [[Interface\TALENTFRAME\ShamanElementalCombat-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 27", [[Interface\TALENTFRAME\ShamanEnhancement-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 28", [[Interface\TALENTFRAME\ShamanRestoration-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 29", [[Interface\TALENTFRAME\WarlockCurses-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 30", [[Interface\TALENTFRAME\WarlockDestruction-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 31", [[Interface\TALENTFRAME\WarlockSummoning-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 32", [[Interface\TALENTFRAME\WarriorArm-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 33", [[Interface\TALENTFRAME\WarriorArms-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 34", [[Interface\TALENTFRAME\WarriorFury-TopLeft]]);
	LSM:Register("background", "InkedSV Model BG 35", [[Interface\TALENTFRAME\WarriorProtection-TopLeft]]);
end
