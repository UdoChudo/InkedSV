...
local bubbleBackdrop = {
	bgFile = [[Interface\AddOns\InkedSV_!Core\assets\textures\CHATBUBBLE-BG]],
    tile = false,
    tileSize = 0,
    edgeFile = [[Interface\AddOns\InkedSV_!Core\assets\textures\CHATBUBBLE-BACKDROP]],
    edgeSize = 15,
    insets =
    {
        left = 15,
...
local function StyleStoryline()
	...
	tail0:SetTexture([[Interface\AddOns\InkedSV_!Core\assets\textures\CHATBUBBLE-TAIL-UP]])
	...
	tail:SetTexture([[Interface\AddOns\InkedSV_!Core\assets\textures\CHATBUBBLE-TAIL-LEFT]])
