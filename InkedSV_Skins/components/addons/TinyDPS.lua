...
local function StyleTinyDPS()
	...
	if tdpsStatusBar then
		tdpsStatusBar:SetBackdrop({bgFile = SV.media.background.default, edgeFile = [[Interface\AddOns\InkedSV_!Core\assets\textures\EMPTY]], tile = false, tileSize = 0, edgeSize = 1})
