...
local THFMinion = CreateFrame("Frame", "InkedSV_THFMinion");
local thf;
...
local function initializeTHF()
	...
	thf = CreateFrame("Frame", "InkedSV_TalkingHeadFrame", UIParent);
...
function SV:MoveTHF()
	TalkingHeadFrame:SetPoint("TOP", InkedSV_TalkingHeadFrame_MOVE, 0, 0);
end
