...
--[[
		...
		PaperDollFrame:SetPoint("TOPLEFT", DressUpFrame, "TOPLEFT", 12, -76)
		PaperDollFrame:SetPoint("BOTTOMRIGHT", DressUpFrame, "BOTTOMRIGHT", -12, 36)

		PaperDollFrame:SetStyle("!_Frame", "Model")
]]--
	...
	if(SV.db.Skins.blizzard.loot) then
		...
		-- BonusRollFrame.PromptFrame.Icon:SetTexCoord(unpack(_G.InkedSV_ICON_COORDS))
	...
	if(SV.db.Skins.blizzard.mail) then
		...
		OpenMailLetterButtonIconTexture:SetTexCoord(unpack(_G.InkedSV_ICON_COORDS))
		OpenMailLetterButtonIconTexture:InsetPoints()

		OpenMailMoneyButton:RemoveTextures()
		OpenMailMoneyButton:SetStyle("Button")
		OpenMailMoneyButtonIconTexture:SetTexCoord(unpack(_G.InkedSV_ICON_COORDS))
	...
	if(SV.db.Skins.blizzard.merchant) then
		...
		MerchantBuyBackItemItemButton:RemoveTextures()
		MerchantBuyBackItemItemButton:SetStyle("Button")
		MerchantBuyBackItemItemButtonIconTexture:SetTexCoord(unpack(_G.InkedSV_ICON_COORDS))
	...
	if(SV.db.Skins.blizzard.stable) then
		...
		PetStableSelectedPetIcon:SetTexCoord(unpack(_G.InkedSV_ICON_COORDS))
	end
