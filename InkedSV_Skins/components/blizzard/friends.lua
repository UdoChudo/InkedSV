...
local function ChannelList_OnUpdate()
	for i = 1, MAX_DISPLAY_CHANNEL_BUTTONS do 
		...
		if btn then
			...
			_G["ChannelButton"..i.."Text"]:SetFontObject(InkedSV_Font_Default)
		end 
	end 
end 
--[[ 
...
--	FriendsFrameFriendsScrollFrame:DisableDrawLayer("BACKGROUND")
	...
	FriendsFrameBattlenetFrame.Tag:SetFontObject(InkedSV_Font_Narrator)
	...
	FriendsTabHeaderSoRButtonIcon:SetTexCoord(unpack(_G.InkedSV_ICON_COORDS))
	...
	FriendsTabHeaderRecruitAFriendButtonIcon:SetTexCoord(unpack(_G.InkedSV_ICON_COORDS))
