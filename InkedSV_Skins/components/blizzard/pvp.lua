...
local _hook_PVPReadyDialogDisplay = function(self, _, _, _, queueType, _, queueRole)
	PVPReadyDialogRoleIconTexture:SetTexture("Interface\\AddOns\\InkedSV_Skins\\artwork\\UI-LFG-ICON-ROLES")
...
local function PVPFrameStyle()
	...
	HonorFrame.TankIcon:SetNormalTexture("Interface\\AddOns\\InkedSV_Skins\\artwork\\UI-LFG-ICON-ROLES")
	HonorFrame.HealerIcon:DisableDrawLayer("OVERLAY")
	HonorFrame.HealerIcon:DisableDrawLayer("BACKGROUND")
	HonorFrame.HealerIcon:SetNormalTexture("Interface\\AddOns\\InkedSV_Skins\\artwork\\UI-LFG-ICON-ROLES")
	HonorFrame.DPSIcon:DisableDrawLayer("OVERLAY")
	HonorFrame.DPSIcon:DisableDrawLayer("BACKGROUND")
	HonorFrame.DPSIcon:SetNormalTexture("Interface\\AddOns\\InkedSV_Skins\\artwork\\UI-LFG-ICON-ROLES")
