...
local function ArchaeologyStyle()
	...
	for b = 1, ARCHAEOLOGY_MAX_COMPLETED_SHOWN do
		...
		if c then
			...
			_G["ArchaeologyFrameCompletedPageArtifact"..b.."Icon"]:SetTexCoord(unpack(_G.InkedSV_ICON_COORDS))
	...
	ArchaeologyFrameArtifactPageIcon:SetTexCoord(unpack(_G.InkedSV_ICON_COORDS))
	...
	local progressBarHolder = CreateFrame("Frame", "InkedSV_ArcheologyProgressBar", SV.Screen)
	...
	ArcheologyDigsiteProgressBar.Shadow:SetTexture("Interface\\AddOns\\InkedSV_Skins\\artwork\\ArcheologyToast")
	ArcheologyDigsiteProgressBar.BarBackground:SetTexture("Interface\\AddOns\\InkedSV_Skins\\artwork\\ArcheologyToast")
	ArcheologyDigsiteProgressBar.BarBorderAndOverlay:SetTexture("Interface\\AddOns\\InkedSV_Skins\\artwork\\ArcheologyToast")
	ArcheologyDigsiteProgressBar.Flash:SetTexture("Interface\\AddOns\\InkedSV_Skins\\artwork\\ArcheologyToast")
	ArcheologyDigsiteProgressBar.FillBar:SetStatusBarTexture("Interface\\AddOns\\InkedSV_Skins\\artwork\\Arch-Progress-Fill")
end
--[[
##########################################################
MOD LOADING
