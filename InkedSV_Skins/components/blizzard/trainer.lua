...
local function TrainerStyle()
	...
	for i=1, 8 do
		...
		if item then
			...
			_G["ClassTrainerScrollFrameButton"..i.."Icon"]:SetTexCoord(unpack(_G.InkedSV_ICON_COORDS))
	...
	ClassTrainerFrameSkillStepButton.icon:SetTexCoord(unpack(_G.InkedSV_ICON_COORDS))
