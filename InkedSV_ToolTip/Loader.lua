...
MOD.media.topArt = [[Interface\AddOns\InkedSV_ToolTip\assets\TT-TOP]];
MOD.media.bottomArt = [[Interface\AddOns\InkedSV_ToolTip\assets\TT-BOTTOM]];
MOD.media.rightArt = [[Interface\AddOns\InkedSV_ToolTip\assets\TT-RIGHT]];
MOD.media.leftArt = [[Interface\AddOns\InkedSV_ToolTip\assets\TT-LEFT]];
...
SV:AssignMedia("font", "tipdialog", "InkedSV Default Font", 12, "OUTLINE");
SV:AssignMedia("font", "tipheader", "InkedSV Default Font", 14, "OUTLINE");
