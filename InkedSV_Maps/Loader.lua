...
MOD.media = {}
MOD.media.customBlips = [[Interface\AddOns\InkedSV_Maps\assets\MINIMAP-OBJECTICONS]];
MOD.media.defaultBlips = [[Interface\AddOns\InkedSV_Maps\assets\DEFAULT-OBJECTICONS]];
MOD.media.rectangleMask = [[Interface\AddOns\InkedSV_Maps\assets\MINIMAP_MASK_RECTANGLE]];
MOD.media.squareMask = [[Interface\AddOns\InkedSV_Maps\assets\MINIMAP_MASK_SQUARE]];
MOD.media.roundBorder = [[Interface\AddOns\InkedSV_Maps\assets\MINIMAP-ROUND]];
MOD.media.playerArrow = [[Interface\AddOns\InkedSV_Maps\assets\MINIMAP_ARROW]];
MOD.media.corpseArrow = [[Interface\AddOns\InkedSV_Maps\assets\MINIMAP_CORPSE_ARROW]];
MOD.media.guideArrow = [[Interface\AddOns\InkedSV_Maps\assets\MINIMAP_GUIDE_ARROW]];
MOD.media.mailIcon = [[Interface\AddOns\InkedSV_Maps\assets\MINIMAP-MAIL]];
MOD.media.calendarIcon = [[Interface\AddOns\InkedSV_Maps\assets\MINIMAP-CALENDAR]];
MOD.media.trackingIcon = [[Interface\AddOns\InkedSV_Maps\assets\MINIMAP-TRACKING]];

SV:AssignMedia("template", "Minimap", "InkedSV_StyleTemplate_Minimap");
SV:AssignMedia("font", "mapinfo", "InkedSV Narrator Font", 13, "OUTLINE");
SV:AssignMedia("font", "mapcoords", "InkedSV Number Font", 16, "OUTLINE");
SV:AssignMedia("globalfont", "mapinfo", "InkedSV_Font_MinimapInfo");
SV:AssignMedia("globalfont", "mapcoords", "InkedSV_Font_MinimapCoords");
