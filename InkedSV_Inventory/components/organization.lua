...
function MOD:InitializeMenus()
	...
	for i = LE_BAG_FILTER_FLAG_EQUIPMENT, NUM_LE_BAG_FILTER_FLAGS do
		...
		BagFilters.buttons[i].hoverTex:SetTexture([[Interface\AddOns\InkedSV\assets\textures\TITLE-HIGHLIGHT]])
		...
		BagFilters.buttons[i].activeTex:SetTexture([[Interface\AddOns\InkedSV\assets\textures\TITLE-HIGHLIGHT]])
	...
	BagFilters.buttons[clearID].hoverTex:SetTexture([[Interface\AddOns\InkedSV\assets\textures\TITLE-HIGHLIGHT]])
...
local Container_OnEvent = function(self, event, ...)
	...
	elseif(event == "PLAYERREAGENTBANKSLOTS_CHANGED") then
		local slotID = ...
		local container = _G["InkedSV_ReagentContainerFrame"]
