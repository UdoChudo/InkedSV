...
local L = SV.L;
local name, obj = ...;
local MOD = SV:NewModule(name, obj, "InkedSV_LootCache", "InkedSV_Private_LootCache");
...
MOD.media = {}
MOD.media.cleanupIcon = [[Interface\AddOns\InkedSV_Inventory\assets\BAGS-CLEANUP]];
MOD.media.bagIcon = [[Interface\AddOns\InkedSV_Inventory\assets\BAGS-BAGS]];
MOD.media.depositIcon = [[Interface\AddOns\InkedSV_Inventory\assets\BAGS-DEPOSIT]];
MOD.media.purchaseIcon = [[Interface\AddOns\InkedSV_Inventory\assets\BAGS-PURCHASE]];
MOD.media.reagentIcon = [[Interface\AddOns\InkedSV_Inventory\assets\BAGS-REAGENTS]];
MOD.media.sortIcon = [[Interface\AddOns\InkedSV_Inventory\assets\BAGS-SORT]];
MOD.media.stackIcon = [[Interface\AddOns\InkedSV_Inventory\assets\BAGS-STACK]];
MOD.media.transferIcon = [[Interface\AddOns\InkedSV_Inventory\assets\BAGS-TRANSFER]];
MOD.media.vendorIcon = [[Interface\AddOns\InkedSV_Inventory\assets\BAGS-VENDOR]];

SV:AssignMedia("font", "bagdialog", "InkedSV Default Font", 11, "OUTLINE");
SV:AssignMedia("font", "bagnumber", "InkedSV Number Font", 11, "OUTLINE");
SV:AssignMedia("globalfont", "bagdialog", "InkedSV_Font_Bag");
SV:AssignMedia("globalfont", "bagnumber", "InkedSV_Font_Bag_Number");
