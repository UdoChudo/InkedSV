...
local CHARGE_ICON = [[Interface\AddOns\InkedSV_UnitFrames\assets\Class\MAGE-CHARGE]];
local ICICLE_ICON = [[Interface\AddOns\InkedSV_UnitFrames\assets\Class\MAGE-ICICLE]];
...
function MOD:CreateClassBar(playerFrame)
	...
	ignite.text:SetFontObject(InkedSV_Font_Unit_Small)
	...
	--gnite.FX:SetScript("OnShow", EffectModel_OnShow)
	bar.Ignite = bgFrame;
	bar.Ignite:Hide();
