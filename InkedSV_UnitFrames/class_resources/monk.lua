...
local ORB_ICON = [[Interface\AddOns\InkedSV_UnitFrames\assets\Class\ORB]];
local ORB_BG = [[Interface\AddOns\InkedSV_UnitFrames\assets\Class\ORB-BG]];

local STAGGER_BAR = [[Interface\AddOns\InkedSV_UnitFrames\assets\Class\MONK-STAGGER-BAR]];
local STAGGER_BG = [[Interface\AddOns\InkedSV_UnitFrames\assets\Class\MONK-STAGGER-BG]];
local STAGGER_FG = [[Interface\AddOns\InkedSV_UnitFrames\assets\Class\MONK-STAGGER-FG]];
local STAGGER_ICON = [[Interface\AddOns\InkedSV_UnitFrames\assets\Class\MONK-STAGGER-ICON]];

local CHI_FILE = [[Interface\Addons\InkedSV_UnitFrames\assets\Class\MONK]];
local CHI_COORDS = {
	[1] = {0,0.5,0,0.5},
	[2] = {0.5,1,0,0.5},
	[3] = {0,0.5,0.5,1},
