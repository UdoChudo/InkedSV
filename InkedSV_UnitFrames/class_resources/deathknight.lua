...
local RUNE_FG = [[Interface\AddOns\InkedSV_UnitFrames\assets\Class\RUNES-FG]];
local RUNE_BG = [[Interface\AddOns\InkedSV_UnitFrames\assets\Class\RUNES-BG]];
local runeColors = {
	{0.75, 0, 0},   -- blood
	{0, 0.75, 1},   -- frost
	{0.1, 0.75, 0},  -- unholy
...
local runeTextures = {
	[[Interface\AddOns\InkedSV_UnitFrames\assets\Class\DEATHKNIGHT-BLOOD]],
	[[Interface\AddOns\InkedSV_UnitFrames\assets\Class\DEATHKNIGHT-FROST]],
	[[Interface\AddOns\InkedSV_UnitFrames\assets\Class\DEATHKNIGHT-UNHOLY]],
	[[Interface\AddOns\InkedSV_UnitFrames\assets\Class\DEATHKNIGHT-DEATH]]
};
local runeClassic = {
	runeTextures[1],
	runeTextures[1],
