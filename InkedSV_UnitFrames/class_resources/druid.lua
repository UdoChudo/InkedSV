...
local comboTextures = {
    [1]=[[Interface\Addons\InkedSV_UnitFrames\assets\Class\DRUID-CLAW-UP]],
    [2]=[[Interface\Addons\InkedSV_UnitFrames\assets\Class\DRUID-CLAW-DOWN]],
    [3]=[[Interface\Addons\InkedSV_UnitFrames\assets\Class\DRUID-BITE]],
};
...
local Reposition = function(self)
	...
	local bar = self.HyperComboDruid;
...
function MOD:CreateClassBar(playerFrame)
	...
	playerFrame.HyperComboDruid = bar
	return 'HyperComboDruid'
end
