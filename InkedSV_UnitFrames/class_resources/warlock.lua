...
local FURY_FONT = [[Interface\AddOns\InkedSV\assets\fonts\Numbers.ttf]]
local shardColors = {
...
local shardTextures = {
	[1] = {
		[[Interface\Addons\InkedSV_UnitFrames\assets\Class\WARLOCK-SHARD]],
		[[Interface\Addons\InkedSV_UnitFrames\assets\Class\WARLOCK-SHARD-BG]],
		[[Interface\Addons\InkedSV_UnitFrames\assets\Class\WARLOCK-SHARD-FG]]
	},
	[2] = {
		[[Interface\Addons\InkedSV_UnitFrames\assets\Class\WARLOCK-SHARD]],
		[[Interface\Addons\InkedSV_UnitFrames\assets\Class\WARLOCK-SHARD-BG]],
	...
	[3] = {
		[[Interface\Addons\InkedSV_UnitFrames\assets\Class\WARLOCK-EMBER]],
		[[Interface\Addons\InkedSV_UnitFrames\assets\Class\WARLOCK-EMBER]],
		[[Interface\Addons\InkedSV_UnitFrames\assets\Class\WARLOCK-EMBER-FG]]
	},
}
