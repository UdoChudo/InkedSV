...
function MOD:CreateClassBar(playerFrame)
	...
	for i = 1, max do
		...
		bar[i]:SetStatusBarTexture("Interface\\AddOns\\InkedSV_UnitFrames\\assets\\Class\\PALADIN-HAMMER-FG")
		bar[i]:GetStatusBarTexture():SetHorizTile(false)
		bar[i]:SetStatusBarColor(0.9,0.9,0.8)

		-- bar[i].bg = underlay:CreateTexture(nil,"BORDER")
		-- bar[i].bg:SetAllPoints(underlay)
		-- bar[i].bg:SetTexture("Interface\\AddOns\\InkedSV_UnitFrames\\assets\\Class\\PALADIN-HAMMER-BG")
