...
local _PRIVATE_METHODS = {
	...
	ColorGradient = oUF_InkedSV.ColorGradient,
};
...
local function SetProxyEnv()
	...
	for i=1, 30 do
		_PRIVATE_TAGS['name:'..i] = oUF_InkedSV.Tags.Methods['name:'..i]
	end

	_PRIVATE_TAGS['name:color'] = oUF_InkedSV.Tags.Methods['name:color']
	_PRIVATE_TAGS['name:grid'] = oUF_InkedSV.Tags.Methods['name:grid']
	_PRIVATE_TAGS['health:color'] = oUF_InkedSV.Tags.Methods['health:color']
	_PRIVATE_TAGS['health:current'] = oUF_InkedSV.Tags.Methods['health:current']
	_PRIVATE_TAGS['health:deficit'] = oUF_InkedSV.Tags.Methods['health:deficit']
	_PRIVATE_TAGS['health:curpercent'] = oUF_InkedSV.Tags.Methods['health:curpercent']
	_PRIVATE_TAGS['health:curmax'] = oUF_InkedSV.Tags.Methods['health:curmax']
	_PRIVATE_TAGS['health:curmax-percent'] = oUF_InkedSV.Tags.Methods['health:curmax-percent']
	_PRIVATE_TAGS['health:max'] = oUF_InkedSV.Tags.Methods['health:max']
	_PRIVATE_TAGS['health:percent'] = oUF_InkedSV.Tags.Methods['health:percent']
	_PRIVATE_TAGS['power:color'] = oUF_InkedSV.Tags.Methods['power:color']
	_PRIVATE_TAGS['power:current'] = oUF_InkedSV.Tags.Methods['power:current']
	_PRIVATE_TAGS['power:deficit'] = oUF_InkedSV.Tags.Methods['power:deficit']
	_PRIVATE_TAGS['power:curpercent'] = oUF_InkedSV.Tags.Methods['power:curpercent']
	_PRIVATE_TAGS['power:curmax'] = oUF_InkedSV.Tags.Methods['power:curmax']
	_PRIVATE_TAGS['power:curmax-percent'] = oUF_InkedSV.Tags.Methods['power:curmax-percent']
	_PRIVATE_TAGS['power:max'] = oUF_InkedSV.Tags.Methods['power:max']
	_PRIVATE_TAGS['power:percent'] = oUF_InkedSV.Tags.Methods['power:percent']
end
