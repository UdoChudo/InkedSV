...
BodyGuard.UF = CreateFrame("Button", "InkedSV_BodyGuard", UIParent, "SecureActionButtonTemplate")
...
function BodyGuard:HealthUpdate()
  ...
  local r, g, b = unpack(oUF_InkedSV.colors.health)
  r, g, b = oUF_InkedSV.ColorGradient(health, maxHealth, 1, 0, 0, 1, 1, 0, r, g, b)
...
function MOD:InitializeBodyGuard()
  ...
  BodyGuard.UF.Name:SetTextColor(unpack(oUF_InkedSV.colors.reaction[5]))
