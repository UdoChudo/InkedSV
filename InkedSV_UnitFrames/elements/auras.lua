...
local InkedSV_Font_UnitAura 		= _G.InkedSV_Font_UnitAura;
local InkedSV_Font_UnitAura_Bar 	= _G.InkedSV_Font_UnitAura_Bar;
--[[
##########################################################
LOCAL FUNCTIONS
##########################################################
...
local CreateAuraIcon = function(icons, index)
  ...
  local fontgroup = "InkedSV_Font_UnitAura";
  if(baseSize < 18) then
  	fontgroup = "InkedSV_Font_UnitAura_Small";
  end
  --print(baseSize)
  --print(fontgroup)
...
local PostCreateAuraBars = function(self)
	...
	bar.spelltime:SetFontObject(InkedSV_Font_UnitAura_Bar);
	...
	bar.spellname:SetFontObject(InkedSV_Font_UnitAura_Bar);
...
local function UpdateAuraMediaLocals()
	BUFFS_COLOR = oUF_InkedSV.colors.buff_bars or DEFAULT_BUFFS_COLOR;
	DEBUFFS_COLOR = oUF_InkedSV.colors.debuff_bars or DEFAULT_DEBUFFS_COLOR;
