...
local function SetCastTicks(bar,count,mod)
	...
	for i=1,count do
		if not ticks[i] then
			...
			ticks[i]:SetVertexColor(0.5,0.5,0.5,0.8)
			ticks[i]:SetWidth(1)
...
local CustomInterruptible = function(self, unit, useClass)
	local colors = oUF_InkedSV.colors
...
function MOD:CreateCastbar(frame, reversed, moverName, ryu, useFader, isBoss, hasModel)
	...
	buttonIcon:SetTexCoord(unpack(_G.InkedSV_ICON_COORDS))
	...
	shieldIcon:SetTexture("Interface\\Addons\\InkedSV_UnitFrames\\assets\\Castbar\\SHIELD.blp")
	...
	if ryu then
		castbar.Time:SetFontObject(InkedSV_Font_Aura)
		castbar.Time:SetTextColor(1, 1, 1)
		castbar.Text:SetFontObject(InkedSV_Font_Caps)
		...
		if reversed then
			...
			hadouken[1]:SetTexture("Interface\\Addons\\InkedSV_UnitFrames\\assets\\Castbar\\HADOUKEN-REVERSED.blp")
			...
			hadouken[1].overlay:SetTexture("Interface\\Addons\\InkedSV_UnitFrames\\assets\\Castbar\\SKULLS-REVERSED.blp")
			...
			hadouken[2]:SetTexture("Interface\\Addons\\InkedSV_UnitFrames\\assets\\Castbar\\CHANNEL-REVERSED.blp")
			...
			hadouken[2].overlay:SetTexture("Interface\\Addons\\InkedSV_UnitFrames\\assets\\Castbar\\CHANNEL-REVERSED.blp")
			...
			hadouken[1]:SetAllPoints(hadouken)
			hadouken[1]:SetBlendMode("ADD")
			hadouken[1]:SetTexture("Interface\\Addons\\InkedSV_UnitFrames\\assets\\Castbar\\HADOUKEN.blp")
			hadouken[1]:SetVertexColor(colors.spark[1],colors.spark[2],colors.spark[3])
			hadouken[1].overlay = hadouken:CreateTexture(nil, "OVERLAY")
			hadouken[1].overlay:SetHeight(50)
			hadouken[1].overlay:SetWidth(50)
			hadouken[1].overlay:SetPoint("CENTER", hadouken)
			hadouken[1].overlay:SetBlendMode("ADD")
			hadouken[1].overlay:SetTexture("Interface\\Addons\\InkedSV_UnitFrames\\assets\\Castbar\\HADOUKEN.blp")
			hadouken[1].overlay:SetVertexColor(1, 1, 1)
			...
			hadouken[2]:InsetPoints(hadouken, 4, 4)
			hadouken[2]:SetBlendMode("ADD")
			hadouken[2]:SetTexture("Interface\\Addons\\InkedSV_UnitFrames\\assets\\Castbar\\CHANNEL.blp")
			hadouken[2]:SetVertexColor(colors.spark[1],colors.spark[2],colors.spark[3])
			hadouken[2].overlay = hadouken:CreateTexture(nil, "OVERLAY")
			hadouken[2].overlay:SetHeight(50)
			hadouken[2].overlay:SetWidth(50)
			hadouken[2].overlay:SetPoint("CENTER", hadouken)
			hadouken[2].overlay:SetBlendMode("ADD")
			hadouken[2].overlay:SetTexture("Interface\\Addons\\InkedSV_UnitFrames\\assets\\Castbar\\CHANNEL.blp")
			hadouken[2].overlay:SetVertexColor(1, 1, 1)
	...
	castbar.CastColor = oUF_InkedSV.colors.casting
	castbar.SparkColor = oUF_InkedSV.colors.spark
