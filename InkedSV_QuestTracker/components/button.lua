...
modified/minimally re-written for SVUI by Failcoder used in InkedSV
...
function MOD:InitializeQuestItem()
	InkedSV_QuestItemBar:SetParent(SV.Screen)
	InkedSV_QuestItemBar:SetPoint("BOTTOM", SV.Screen, "BOTTOM", 0, 250)
	InkedSV_QuestItemBar:SetSize(40,40)

	SV:NewAnchor(InkedSV_QuestItemBar, L["Quest Item Button"])

	local questitem = SV:CreateSecureButton("item", "InkedSV_QuestItemBar", "InkedSV_QuestAutoItemButton", UpdateButton);
