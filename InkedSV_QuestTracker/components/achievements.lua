...
local GetAchievementRow = function(self, index)
	if(not self.Rows[index]) then
		...
		row.Badge.Icon:SetTexCoord(unpack(_G.InkedSV_ICON_COORDS))
...
function MOD:InitializeAchievements()
	...
	achievements.Header.Text:SetFontObject(InkedSV_Font_Quest_Header);
	...
	achievements.Header.Divider:SetTexture([[Interface\AddOns\InkedSV\assets\textures\DROPDOWN-DIVIDER]]);
