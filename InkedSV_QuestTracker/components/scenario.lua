...
function MOD:InitializeScenarios()
	...
	block.Icon:SetTexture(LINE_SCENARIO_ICON)
	block.Icon:SetTexCoord(unpack(_G.InkedSV_ICON_COORDS))
	...
	block.Header.Stage:SetFontObject(InkedSV_Font_Quest);
	...
	block.Header.Score:SetFontObject(InkedSV_Font_Quest);
	...
	block.Header.Text:SetFontObject(InkedSV_Font_Quest);
	...
	timer.Bar.Wave:SetFontObject(InkedSV_Font_Quest);
	...
	timer.Bar.TimeLeft:SetFontObject(InkedSV_Font_Quest_Number);
