...
local FRAME_MAP = {
	["player"] = "InkedSV_Player",
	["target"] = "InkedSV_Target",
	["targettarget"] = "InkedSV_TargetTarget",
	["pet"] = "InkedSV_Pet",
	["pettarget"] = "InkedSV_PetTarget",
	["focus"] = "InkedSV_Focus",
	["focustarget"] = "InkedSV_FocusTarget",
};
...
function InkedSVOptions:SetSizeConfigGroup(gridMode, unitName)
...
function InkedSVOptions:SetCastbarConfigGroup(updateFunction, unitName, count)
	local configTable = {
		order = 800,
		type = "group",
		name = L["Castbar"],
...
function InkedSVOptions:SetMiscConfigGroup(partyRaid, updateFunction, unitName, count)
	local miscGroup = {
		order = 99,
		type = "group",
		name = L["Misc Text"],
...
function InkedSVOptions:SetHealthConfigGroup(partyRaid, updateFunction, unitName, count)
	local healthOptions = {
		order = 100,
		type = "group",
		name = L["Health"],
...
function InkedSVOptions:SetPowerConfigGroup(playerTarget, updateFunction, unitName, count)
	local powerOptions = {
		order = 200,
		type = "group",
		name = L["Power"],
...
function InkedSVOptions:SetNameConfigGroup(updateFunction, unitName, count)
	local k = {
		order = 400,
		type = "group",
		name = L['Name'],
...
function InkedSVOptions:SetPortraitConfigGroup(updateFunction, unitName, count)
	local k = {
		order = 400,
		type = "group",
		name = L["Portrait"],
...
function InkedSVOptions:SetIconConfigGroup(updateFunction, unitName, count)
...
function InkedSVOptions:SetAuraConfigGroup(isPlayer, auraType, unused, updateFunction, unitName, count)
		...
		configTable.args.barGroup = {
			...
			args = {
				...
				configureButton2 = {
					...
					type = "execute", func = function() InkedSVOptions:SetToFilterConfig("AuraBars") end,
					disabled = function() return not SV.db.UnitFrames[unitName][auraType].useBars end,
				},
				spacer = {
					order = 4,
...
InkedSVOptions.FilterOptionGroups['AuraBars'] = function(selectedSpell)
			...
			addSpell = {
				...
				set = function(key, value)
					...
					elseif not SV.db.Filters.AuraBars[value] then
						...
						MOD:SetUnitFrame("focus")
						InkedSVOptions:SetFilterOptions('AuraBars', value)
					end
				end
			},
			removeSpell = {
				...
				set = function(key, value)
					...
					MOD:SetUnitFrame("target")
					MOD:SetUnitFrame("focus")
					InkedSVOptions:SetFilterOptions('AuraBars')
				end
			},
			selectSpell = {
				name = L["Select Spell"],
...
InkedSVOptions.FilterOptionSpells['AuraBars'] = function(selectedSpell)
	if(not SV.db.Filters.AuraBars) then SV.db.Filters.AuraBars = {} end;
	local RESULT;
...
InkedSVOptions.FilterOptionGroups['BuffWatch'] = function(selectedSpell)
	...
	local RESULT = {
		...
		args = {
			addSpellID = {
				...
				set = function(key, value)
					...
					elseif(not GetSpellInfo(spellID)) then
						...
						UpdateBuffWatch()
						InkedSVOptions:SetFilterOptions('BuffWatch', spellID)
					end
				end
			},
			removeSpellID = {
				...
				set = function(key, value)
					...
					elseif(not GetSpellInfo(spellID)) then
						...
						if temp == nil then
							...
							InkedSVOptions:SetFilterOptions('BuffWatch')
						end
					end
			...
			selectSpell = {
				...
				get = function(key) return selectedSpell end,
				set = function(key, value) InkedSVOptions:SetFilterOptions('BuffWatch', value) end
			}
		}
	}
	return RESULT;
...
InkedSVOptions.FilterOptionSpells['BuffWatch'] = function(selectedSpell)
	local RESULT;
	local FILTER = SV.db.Filters.BuffWatch;
...
InkedSVOptions.FilterOptionGroups['PetBuffWatch'] = function(selectedSpell)
			...
			addSpellID = {
				...
				set = function(key, value)
					...
					elseif(not GetSpellInfo(spellID)) then
						...
						UpdatePetBuffWatch()
						InkedSVOptions:SetFilterOptions('PetBuffWatch', spellID)
					end
				end
			},
			removeSpellID = {
				...
				set = function(key, value)
					...
					elseif(not GetSpellInfo(spellID)) then
						...
						if not success then
							...
							InkedSVOptions:SetFilterOptions()
						end
					end
					UpdatePetBuffWatch()
					InkedSVOptions:SetFilterOptions('PetBuffWatch', value)
				end
			},
			selectSpell = {
				name = L["Select Spell"],
				...
				get = function(key) return selectedSpell end,
				set = function(key, value) InkedSVOptions:SetFilterOptions('PetBuffWatch', value) end
			}
		}
	};
...
InkedSVOptions.FilterOptionSpells['PetBuffWatch'] = function(selectedSpell)
	local RESULT;
	local FILTER = SV.db.Filters.PetBuffWatch;
			...
			args = {
						...
						backgroundGroup = {
							...
							args = {
								unitlarge = {
									...
									values = AceInkedWidgets.background,
								},
								unitsmall = {
									type = "select",
									dialogControl = "LSM30_Background",
						...
						barGroup = {
							...
							args = {
								...
								statusbar = {
									...
									values = AceInkedWidgets.statusbar
								},
								auraBarStatusbar = {
									type = "select",
									dialogControl = "LSM30_Statusbar",
						...
						fontGroup = {
							...
							args = {
								fontConfigButton = {
									...
									type = "execute", func = function() InkedSVOptions:SetToFontConfig("UnitFrame") end
								},
							}
						},
						allColorsGroup = {
				...
				player = {
					...
					args = {
									...
									args = {
										combatfade = {
											...
											set = function(l, m)
												...
												MOD:SetUnitFrame("player")
												if m == true then
													InkedSV_Pet:SetParent(InkedSV_Player)
												else
													InkedSV_Pet:SetParent(InkedSV_UnitFrameParent)
												end
											end
										},
										predict = {
						...
						misc = InkedSVOptions:SetMiscConfigGroup(false, MOD.SetUnitFrame, "player"),
						health = InkedSVOptions:SetHealthConfigGroup(false, MOD.SetUnitFrame, "player"),
						power = InkedSVOptions:SetPowerConfigGroup(true, MOD.SetUnitFrame, "player"),
						name = InkedSVOptions:SetNameConfigGroup(MOD.SetUnitFrame, "player"),
						portrait = InkedSVOptions:SetPortraitConfigGroup(MOD.SetUnitFrame, "player"),
						buffs = InkedSVOptions:SetAuraConfigGroup(true, "buffs", false, MOD.SetUnitFrame, "player"),
						debuffs = InkedSVOptions:SetAuraConfigGroup(true, "debuffs", false, MOD.SetUnitFrame, "player"),
						castbar = InkedSVOptions:SetCastbarConfigGroup(MOD.SetUnitFrame, "player"),
						icons = InkedSVOptions:SetIconConfigGroup(MOD.SetUnitFrame, "player"),
						classbar = {
							order = 1000,
							type = "group",
							name = L["Classbar"],
							...
							args = {
								...
								altComboPoints = {
									...
									disabled = function() return playerClass ~= 'ROGUE' or playerClass ~= 'DRUID' end
								},
								enableStagger = {
									type = "toggle",
									order = 7,
				...
				pet = {
					...
					args = {
						...
						commonGroup = {
							...
							args = {
								showAuras = {
									...
									type = "execute",
									name = L["Show Auras"],
									func = function()local U = InkedSV_Pet;if U.forceShowAuras then U.forceShowAuras = nil else U.forceShowAuras = true end MOD:SetUnitFrame("pet")end
								},
								miscGroup = {
									order = 2,
									type = "group",
						...
						misc = InkedSVOptions:SetMiscConfigGroup(false, MOD.SetUnitFrame, "pet"),
						health = InkedSVOptions:SetHealthConfigGroup(false, MOD.SetUnitFrame, "pet"),
						power = InkedSVOptions:SetPowerConfigGroup(false, MOD.SetUnitFrame, "pet"),
						portrait = InkedSVOptions:SetPortraitConfigGroup(MOD.SetUnitFrame, "pet"),
						name = InkedSVOptions:SetNameConfigGroup(MOD.SetUnitFrame, "pet"),
						buffs = InkedSVOptions:SetAuraConfigGroup(true, "buffs", false, MOD.SetUnitFrame, "pet"),
						debuffs = InkedSVOptions:SetAuraConfigGroup(true, "debuffs", false, MOD.SetUnitFrame, "pet")
					}
				},
				pettarget = {
					name = L["Pet Target"],
					...
					args = {
						...
						commonGroup = {
							...
							args = {
								showAuras = {
									...
									type = "execute",
									name = L["Show Auras"],
									func = function()local U = InkedSV_PetTarget;if U.forceShowAuras then U.forceShowAuras = nil else U.forceShowAuras = true end MOD:SetUnitFrame("pettarget")end
								},
								miscGroup = {
									order = 2,
									type = "group",
						...
						misc = InkedSVOptions:SetMiscConfigGroup(false, MOD.SetUnitFrame, "pettarget"),
						health = InkedSVOptions:SetHealthConfigGroup(false, MOD.SetUnitFrame, "pettarget"),
						power = InkedSVOptions:SetPowerConfigGroup(false, MOD.SetUnitFrame, "pettarget"),
						name = InkedSVOptions:SetNameConfigGroup(MOD.SetUnitFrame, "pettarget"),
						buffs = InkedSVOptions:SetAuraConfigGroup(false, "buffs", false, MOD.SetUnitFrame, "pettarget"),
						debuffs = InkedSVOptions:SetAuraConfigGroup(false, "debuffs", false, MOD.SetUnitFrame, "pettarget")
					}
				},
				target = {
					name = L['Target'],
					...
					args={
								...
								baseGroup = {
									...
									args = {
										showAuras = {
											...
											type = "execute",
											name = L["Show Auras"],
											func = function()local U = InkedSV_Target;if U.forceShowAuras then U.forceShowAuras = nil else U.forceShowAuras = true end MOD:SetUnitFrame("target")end
										},
										predict = {
											order = 2,
											name = L["Heal Prediction"],
						...
						misc = InkedSVOptions:SetMiscConfigGroup(false, MOD.SetUnitFrame, "target"),
						health = InkedSVOptions:SetHealthConfigGroup(false, MOD.SetUnitFrame, "target"),
						power = InkedSVOptions:SetPowerConfigGroup(true, MOD.SetUnitFrame, "target"),
						name = InkedSVOptions:SetNameConfigGroup(MOD.SetUnitFrame, "target"),
						portrait = InkedSVOptions:SetPortraitConfigGroup(MOD.SetUnitFrame, "target"),
						buffs = InkedSVOptions:SetAuraConfigGroup(false, "buffs", false, MOD.SetUnitFrame, "target"),
						debuffs = InkedSVOptions:SetAuraConfigGroup(false, "debuffs", false, MOD.SetUnitFrame, "target"),
						castbar = InkedSVOptions:SetCastbarConfigGroup(MOD.SetUnitFrame, "target"),
						icons = InkedSVOptions:SetIconConfigGroup(MOD.SetUnitFrame, "target")
					}
				},
				targettarget = {
					...
					args={
								...
								baseGroup = {
									...
									args = {
										showAuras = {
											...
											type = "execute",
											name = L["Show Auras"],
											func = function()local U = InkedSV_TargetTarget;if U.forceShowAuras then U.forceShowAuras = nil else U.forceShowAuras = true end MOD:SetUnitFrame("targettarget")end
										},
										spacer1 = {
											order = 2,
											type = "description",
						...
						misc = InkedSVOptions:SetMiscConfigGroup(false, MOD.SetUnitFrame, "targettarget"),
						health = InkedSVOptions:SetHealthConfigGroup(false, MOD.SetUnitFrame, "targettarget"),
						power = InkedSVOptions:SetPowerConfigGroup(nil, MOD.SetUnitFrame, "targettarget"),
						name = InkedSVOptions:SetNameConfigGroup(MOD.SetUnitFrame, "targettarget"),
						portrait = InkedSVOptions:SetPortraitConfigGroup(MOD.SetUnitFrame, "targettarget"),
						buffs = InkedSVOptions:SetAuraConfigGroup(false, "buffs", false, MOD.SetUnitFrame, "targettarget"),
						debuffs = InkedSVOptions:SetAuraConfigGroup(false, "debuffs", false, MOD.SetUnitFrame, "targettarget"),
						icons = InkedSVOptions:SetIconConfigGroup(MOD.SetUnitFrame, "targettarget")
					}
				},
				focus = {
					name = L["Focus"],
					...
					args = {
								...
								baseGroup = {
									...
									args = {
										showAuras = {
											...
											type = "execute",
											name = L["Show Auras"],
											func = function()local U = InkedSV_Focus;if U.forceShowAuras then U.forceShowAuras = nil else U.forceShowAuras = true end MOD:SetUnitFrame("focus")end
										},
										rangeCheck = {
											order = 2,
											name = L["Range Check"],
						...
						misc = InkedSVOptions:SetMiscConfigGroup(false, MOD.SetUnitFrame, "focus"),
						health = InkedSVOptions:SetHealthConfigGroup(false, MOD.SetUnitFrame, "focus"),
						power = InkedSVOptions:SetPowerConfigGroup(nil, MOD.SetUnitFrame, "focus"),
						name = InkedSVOptions:SetNameConfigGroup(MOD.SetUnitFrame, "focus"),
						buffs = InkedSVOptions:SetAuraConfigGroup(false, "buffs", false, MOD.SetUnitFrame, "focus"),
						debuffs = InkedSVOptions:SetAuraConfigGroup(false, "debuffs", false, MOD.SetUnitFrame, "focus"),
						castbar = InkedSVOptions:SetCastbarConfigGroup(MOD.SetUnitFrame, "focus"),
						icons = InkedSVOptions:SetIconConfigGroup(MOD.SetUnitFrame, "focus")
					}
				},
				focustarget = {
					name = L["FocusTarget"],
					...
					args = {
								...
								baseGroup = {
									...
									args = {
										showAuras = {
											...
											name = L["Show Auras"],
											func = function()
												if(InkedSV_FocusTarget.forceShowAuras == true) then
													InkedSV_FocusTarget.forceShowAuras = nil
												else
													InkedSV_FocusTarget.forceShowAuras = true
												end
						...
						misc = InkedSVOptions:SetMiscConfigGroup(false, MOD.SetUnitFrame, "focustarget"),
						health = InkedSVOptions:SetHealthConfigGroup(false, MOD.SetUnitFrame, "focustarget"),
						power = InkedSVOptions:SetPowerConfigGroup(false, MOD.SetUnitFrame, "focustarget"),
						name = InkedSVOptions:SetNameConfigGroup(MOD.SetUnitFrame, "focustarget"),
						buffs = InkedSVOptions:SetAuraConfigGroup(false, "buffs", false, MOD.SetUnitFrame, "focustarget"),
						debuffs = InkedSVOptions:SetAuraConfigGroup(false, "debuffs", false, MOD.SetUnitFrame, "focustarget"),
						icons = InkedSVOptions:SetIconConfigGroup(MOD.SetUnitFrame, "focustarget")
					}
				},
				party = {
					name = L['Party'],
					...
					args = {
						...
						configureToggle = {
							...
							func = function()
								MOD:ViewGroupFrames(InkedSV_Party, InkedSV_Party.forceShow ~= true or nil)
							end,
						},
						resetSettings = {
							type = 'execute',
							...
							args = {
								...
								layoutGroup = {
									...
									args = {
											...
											args = {
												enable = {
													...
													set = function(key, value)
														...
														SV.Options.args.UnitFrames.args.commonGroup.args.party.args.general.args.layoutGroup.args.sizing = InkedSVOptions:SetSizeConfigGroup(value, "party");
													end,
												},
												invertGroupingOrder = {
													order = 2,
										...
										sizing = InkedSVOptions:SetSizeConfigGroup(SV.db.UnitFrames.party.grid.enable, "party"),
										sorting = {
											order = 3,
											name = L["Sorting"],
											type = "group",
											...
											args = {
												gRowCol = {
													...
													set = function(key, value)
														...
														MOD:SetGroupFrame("party")
														if(_G["InkedSV_Raid"] and _G["InkedSV_Raid"].isForced) then
															MOD:ViewGroupFrames(_G["InkedSV_Raid"])
															MOD:ViewGroupFrames(_G["InkedSV_Raid"], true)
														end
													end,
												},
												showBy = {
						...
						auraWatch = {
							...
							args = {
								...
								configureButton = {
									...
									func = function()InkedSVOptions:SetToFilterConfig('BuffWatch')end,
									order = 3,
								},

							},
						},
						misc = InkedSVOptions:SetMiscConfigGroup(true, MOD.SetGroupFrame, 'party'),
						health = InkedSVOptions:SetHealthConfigGroup(true, MOD.SetGroupFrame, 'party'),
						power = InkedSVOptions:SetPowerConfigGroup(false, MOD.SetGroupFrame, 'party'),
						name = InkedSVOptions:SetNameConfigGroup(MOD.SetGroupFrame, 'party'),
						portrait = InkedSVOptions:SetPortraitConfigGroup(MOD.SetGroupFrame, 'party'),
						buffs = InkedSVOptions:SetAuraConfigGroup(true, 'buffs', true, MOD.SetGroupFrame, 'party'),
						debuffs = InkedSVOptions:SetAuraConfigGroup(true, 'debuffs', true, MOD.SetGroupFrame, 'party'),
						petsGroup = {
							order = 800,
							type = 'group',
							name = L['Party Pets'],
						...
						rdebuffs = {
							...
							args = {
								...
								configureToggle = {
									...
									func = function()
										local toggle = (not _G["InkedSV_Party"].forceShowAuras) or nil
										MOD:ViewGroupFrames(_G["InkedSV_Party"], true, toggle)
										MOD:SetGroupFrame('party')
									end,
								},
								configureButton = {
									...
									func = function() InkedSVOptions:SetToFilterConfig("Raid") end,
									order = 3,
								},
								size = {
									type = "range",
						...
						icons = InkedSVOptions:SetIconConfigGroup(MOD.SetGroupFrame, 'party')
					},
				},
				raid = {
					name = "Raid",
					...
					args = {
						...
						configureToggle = {
							...
							name = L["Display Frames"],
							func = function()
								local setForced = (_G["InkedSV_Raid"].forceShow ~= true) or nil;
								MOD:ViewGroupFrames(_G["InkedSV_Raid"], setForced)
							end,
						},
						resetSettings = {
							type = "execute",
							...
							args = {
								...
								layoutGroup = {
									...
									args = {
											...
											args = {
												enable = {
													...
													set = function(key, value)
														...
														SV.Options.args.UnitFrames.args.commonGroup.args.raid.args.general.args.layoutGroup.args.sizing = InkedSVOptions:SetSizeConfigGroup(value, "raid");
													end,
												},
												showPlayer = {
													order = 2,
										...
										sizing = InkedSVOptions:SetSizeConfigGroup(SV.db.UnitFrames.raid.grid.enable, "raid"),
										sorting = {
											order = 3,
											name = L["Sorting"],
											type = "group",
						...
						misc = InkedSVOptions:SetMiscConfigGroup(true, MOD.SetGroupFrame, "raid"),
						health = InkedSVOptions:SetHealthConfigGroup(true, MOD.SetGroupFrame, "raid"),
						power = InkedSVOptions:SetPowerConfigGroup(false, MOD.SetGroupFrame, "raid"),
						name = InkedSVOptions:SetNameConfigGroup(MOD.SetGroupFrame, "raid"),
						buffs = InkedSVOptions:SetAuraConfigGroup(true, "buffs", true, MOD.SetGroupFrame, "raid"),
						debuffs = InkedSVOptions:SetAuraConfigGroup(true, "debuffs", true, MOD.SetGroupFrame, "raid"),
						auraWatch = {
							order = 600,
							type = "group",
							name = L["Aura Watch"],
						...
						rdebuffs = {
							...
							args = {
								...
								configureToggle = {
									...
									name = L["Show Indicators"],
									func = function()
										local toggle = (not _G["InkedSV_Raid"].forceShowAuras) or nil
										MOD:ViewGroupFrames(_G["InkedSV_Raid"], true, toggle)
										MOD:SetGroupFrame("raid")
									end,
								},
								configureButton = {
						...
						icons = InkedSVOptions:SetIconConfigGroup(MOD.SetGroupFrame, "raid"),
					},
				},
				raidpet = {
					order = 12,
					...
					args = {
						...
						configureToggle = {
							...
							type = 'execute',
							name = L['Display Frames'],
							func = function() MOD:ViewGroupFrames(InkedSV_Raidpet, InkedSV_Raidpet.forceShow ~= true or nil); end,
						},
						resetSettings = {
							type = 'execute',
							order = 3,
							...
							args = {
								...
								layoutGroup = {
									...
									args = {
											...
											args = {
												enable = {
													...
													set = function(key, value)
														...
														SV.Options.args.UnitFrames.args.commonGroup.args.raidpet.args.general.args.layoutGroup.args.sizing = InkedSVOptions:SetSizeConfigGroup(value, "raidpet");
													end,
												},
												invertGroupingOrder = {
													order = 2,
										...
										sizing = InkedSVOptions:SetSizeConfigGroup(SV.db.UnitFrames.raidpet.grid.enable, "raidpet"),
										sorting = {
											order = 3,
											name = L["Sorting"],
											type = "group",
						...
						misc = InkedSVOptions:SetMiscConfigGroup(true, MOD.SetGroupFrame, 'raidpet'),
						health = InkedSVOptions:SetHealthConfigGroup(true, MOD.SetGroupFrame, 'raidpet'),
						name = InkedSVOptions:SetNameConfigGroup(MOD.SetGroupFrame, 'raidpet'),
						buffs = InkedSVOptions:SetAuraConfigGroup(true, 'buffs', true, MOD.SetGroupFrame, 'raidpet'),
						debuffs = InkedSVOptions:SetAuraConfigGroup(true, 'debuffs', true, MOD.SetGroupFrame, 'raidpet'),
						auraWatch = {
							order = 600,
							type = 'group',
							name = L['Aura Watch'],
						...
						rdebuffs = {
							...
							args = {
								...
								configureToggle = {
									...
									name = L["Show Indicators"],
									func = function()
										local toggle = (not _G["InkedSV_RaidPet"].forceShowAuras) or nil
										MOD:ViewGroupFrames(_G["InkedSV_RaidPet"], true, toggle)
										MOD:SetGroupFrame('raidpet')
									end,
								},
								configureButton = {
						...
						icons = InkedSVOptions:SetIconConfigGroup(MOD.SetGroupFrame, 'raidpet'),
					},
				},
				boss = {
					name = L["Boss"],
					...
					args = {
						...
						misc = InkedSVOptions:SetMiscConfigGroup(false, MOD.SetEnemyFrame, "boss", MAX_BOSS_FRAMES),
						health = InkedSVOptions:SetHealthConfigGroup(false, MOD.SetEnemyFrame, "boss", MAX_BOSS_FRAMES),
						power = InkedSVOptions:SetPowerConfigGroup(false, MOD.SetEnemyFrame, "boss", MAX_BOSS_FRAMES),
						name = InkedSVOptions:SetNameConfigGroup(MOD.SetEnemyFrame, "boss", MAX_BOSS_FRAMES),
						portrait = InkedSVOptions:SetPortraitConfigGroup(MOD.SetEnemyFrame, "boss", MAX_BOSS_FRAMES),
						buffs = InkedSVOptions:SetAuraConfigGroup(true, "buffs", false, MOD.SetEnemyFrame, "boss", MAX_BOSS_FRAMES),
						debuffs = InkedSVOptions:SetAuraConfigGroup(true, "debuffs", false, MOD.SetEnemyFrame, "boss", MAX_BOSS_FRAMES),
						castbar = InkedSVOptions:SetCastbarConfigGroup(MOD.SetEnemyFrame, "boss", MAX_BOSS_FRAMES),
						icons = InkedSVOptions:SetIconConfigGroup(MOD.SetEnemyFrame, "boss", MAX_BOSS_FRAMES)
					}
				},
				arena = {
					name = L["Arena"],
					...
					args = {
						...
						misc = InkedSVOptions:SetMiscConfigGroup(false, MOD.SetEnemyFrame, "arena", 5),
						health = InkedSVOptions:SetHealthConfigGroup(false, MOD.SetEnemyFrame, "arena", 5),
						power = InkedSVOptions:SetPowerConfigGroup(false, MOD.SetEnemyFrame, "arena", 5),
						name = InkedSVOptions:SetNameConfigGroup(MOD.SetEnemyFrame, "arena", 5),
						portrait = InkedSVOptions:SetPortraitConfigGroup(MOD.SetEnemyFrame, "arena", 5),
						buffs = InkedSVOptions:SetAuraConfigGroup(false, "buffs", false, MOD.SetEnemyFrame, "arena", 5),
						debuffs = InkedSVOptions:SetAuraConfigGroup(false, "debuffs", false, MOD.SetEnemyFrame, "arena", 5),
						castbar = InkedSVOptions:SetCastbarConfigGroup(MOD.SetEnemyFrame, "arena", 5)
					}
				},
				tank = {
					name = L["Tank"],
							...
							args = {
								enable = {
									...
									set = function(key, value)
										...
										SV.Options.args.UnitFrames.args.commonGroup.args.tank.args.commonGroup.args.sizing = InkedSVOptions:SetSizeConfigGroup(value, "tank");
									end,
								},
								invertGroupingOrder = {
									order = 2,
								...
								sizing = InkedSVOptions:SetSizeConfigGroup(SV.db.UnitFrames.tank.grid.enable, "tank"),
							}
						},
						name = InkedSVOptions:SetNameConfigGroup(MOD.SetGroupFrame, "tank"),
						targetsGroup = {
							type = "group",
							name = L["Tank Target"],
							...
							args = {
								enable = {
									...
									set = function(key, value)
										...
										SV.Options.args.UnitFrames.args.commonGroup.args.assist.args.commonGroup.args.sizing = InkedSVOptions:SetSizeConfigGroup(value, "assist");
									end,
								},
								invertGroupingOrder = {
									order = 2,
								...
								sizing = InkedSVOptions:SetSizeConfigGroup(SV.db.UnitFrames.assist.grid.enable, "assist"),
							}
						},
						name = InkedSVOptions:SetNameConfigGroup(MOD.SetGroupFrame, "assist"),
						targetsGroup = {
							type = "group",
